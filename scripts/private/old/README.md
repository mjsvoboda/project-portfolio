...
folder `project-portfolio-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `project-portfolio-snapshots` folder, containing
